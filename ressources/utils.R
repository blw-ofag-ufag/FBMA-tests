...
#' @param LINDAS_df a data.frame. The data.frame must contain this columns: Datum, Produkt and Value 

#' @param filename string Path + file name 
#' @param nbr_digits integer. Number of digits for the rounding 
#' @return A .txt file containing the results of the testing for each product

#Test MARS and LINDAS data
...
#Function to compare two rows and return differences
